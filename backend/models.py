...
class comments(db.Model, UserMixin):
  ...
  comment_id = db.Column(db.Integer, autoincrement = True, primary_key = True, unique = True, nullable = False)
  blog_id = db.Column(db.Integer, db.ForeignKey("users.Uid"), unique = True ,nullable = False)
