            ...
            <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
              <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                ...
                <img v-else src="https://bootdey.com/img/Content/avatar/avatar7.png"
                  ...
                  <a class="btn btn-secondary btn-sm" role="button" aria-pressed="true" style="z-index: 1; margin-top: 5px;" @click="toggleFollow">{{ followText }}</a>
            ...
            <div class="p-4 text-black" style="background-color: #f8f9fa;">
              <div class="d-flex justify-content-end text-center py-1">
                ...
                <div class="px-3">
                  ...
                  <p class="small text-muted mb-0"><a  href="/" class="text-muted" style="margin-left: 10px;">Followers</a></p>
                </div>
                <div>
                  ...
                  <p class="small text-muted mb-0"><a  href="/" class="text-muted" style="margin-left: 10px;">Following</a></p>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    toggleFollow() {
      // const payload = { isFollowing: !this.isFollowing };
      // Make an API call to toggle the follow status
      const token = localStorage.getItem('access_token');
      fetch('http://127.0.0.1:5000/api/FollowStatus/' + this.username, {
        method: 'POST',
        headers: {
        ...
        .then(data => {
          // Update the follow status and display the new button text
          this.isFollowing = data.isFollowing;
          if (this.isFollowing === false) {
            this.user_data.n_followers--;
          }
          else {
            this.user_data.n_followers ++;
          }
    ...
    getProfileData() {
        ...
        // const token = localStorage.getItem('access_token');
        fetch('http://127.0.0.1:5000/api/UserProfileData/' + this.username, {
        ...
        getProfileBlogsData() {
            ...
            // const token = localStorage.getItem('access_token');
            fetch('http://127.0.0.1:5000/api/UserProfileBlogsData/' + this.username , {
