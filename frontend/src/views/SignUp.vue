    ...
    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
      <div class="card" style="border-radius: 15px;">
        <div class="card-body p-3">
          ...
          <form @submit.prevent="sendUserSignUpData">
            ...
            <p class="text-center text-muted mt-3 mb-0">Already have an account? <a href='/'
    ...
    methods: {
        sendUserSignUpData(){
            if(!this.name || !this.username || !this.email || !this.password || !this.repeat_password){
              ...
              body: JSON.stringify({name:this.name, username:this.username, email:this.email, password:this.password, repeat_password:this.repeat_password, })
                })
              .then(response => {
